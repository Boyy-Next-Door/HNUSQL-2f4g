            ...
            while (true) {
                try {
                    ...
                    while (startAt < inputString.length() - 1) {
                        ...
                        if (requestType == Request.REGISTER) {     /*注册*/
                        ...
                        } else if (requestType == Request.LOGIN) {     /*登陆*/
                            //读取从客户端发过来的用户名和密码
                            username = obj.getString("username");
                            password = obj.getString("password");
                            //校验参数
                        ...
                        } else if (requestType == Request.SHOW_DATABASES || requestType == Request.SHOW_TABLES||requestType == Request.DESCRIBE_TABLE) { /*show类操作*/
