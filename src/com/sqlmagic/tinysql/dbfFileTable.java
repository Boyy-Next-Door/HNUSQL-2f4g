...
//      char[] tempRow2 = new char[coldef.size];
//      int end = coldef.position + coldef.size;
//
//      for(int i = coldef.position;i<end;i++){
//         tempRow2[i-coldef.position] = tempRow[i];
//      }
//      String s = new String(tempRow2);
//      System.out.println(s);
      String subString = getSubString(row, coldef.position, coldef.size);
